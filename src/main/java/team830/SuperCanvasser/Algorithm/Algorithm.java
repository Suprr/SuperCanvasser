...
//                c.getGraphicsContext2D().fillRect(bestSol.get(i).get(j).getLatitude() * 5000, bestSol.get(i).get(j).getLongitude() * 5000, 2, 2);
//                if (j != 0) {
...
//                c.getGraphicsContext2D().fillRect(650 + badSol.get(i).get(j).getLatitude() * 5000,badSol.get(i).get(j).y * 5000, 2, 2);
//                if (j != 0) {
//                    c.getGraphicsContext2D().strokeLine(650 + badSol.get(i).get(j - 1).getLatitude() * 5000,  badSol.get(i).get(j - 1).y * 5000, 650 + badSol.get(i).get(j).x * 5000, badSol.get(i).get(j).y * 5000);
//                }
//            }
//        }
//
